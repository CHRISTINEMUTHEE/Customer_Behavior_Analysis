...
```{r}
complete_df$Revenue<-ifelse(complete_df$Revenue==1,"TRUE","FALSE")
complete_df$Weekend<-ifelse(complete_df$Weekend==1,"TRUE","FALSE")
str(complete_df)
```
...
ggplot(complete_df, 
  ...
  labs(title = "Bounce rate distribution and revenue status")
```
